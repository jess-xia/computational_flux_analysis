...
msigdb_hallmark <- msigdbr(species = "Homo sapiens", category = "H")  # "H" = Hallmark
head(msigdb_hallmark)

# Prepare named, sorted gene list for GSEA
...
gsea_results <- GSEA(geneList = gene_list,
                     TERM2GENE = msigdb_hallmark[, c("gs_name", "gene_symbol")],
                     pvalueCutoff = 0.05,
                     verbose = FALSE)
...
# Save results to CSV
write.csv(gsea_results@result,
          "D:/Users/Jessica/METAFlux/computational_flux_analysis/processed/scrnaseq_gsea_results_macrophage_vs_tumor.csv",
          row.names = FALSE)
